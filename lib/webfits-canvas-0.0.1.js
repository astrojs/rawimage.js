  ...
  Api = (function(_super) {
    ...
    Api.prototype.setStretch = function(value) {
      ...
      switch (value) {
        ...
        case 'arcsinh':
          this.stretch = function(value) {
            return _this.arcsinh(value / -0.033) / _this.arcsinh(1.0 / -0.033);
          };
          break;
        case 'power':
          this.stretch = function(value) {
    ...
    Api.prototype.drawGrayscale = function() {
      ...
      arr = imgData.data;
      min = this.stretch(this.minimum);
      max = this.stretch(this.maximum);
      range = max - min;
      length = arr.length;
      while (length -= 4) {
        value = 255 * (this.stretch(data[length / 4]) - min) / range;
        arr[length + 0] = value;
        arr[length + 1] = value;
        arr[length + 2] = value;
        arr[length + 3] = 255;
